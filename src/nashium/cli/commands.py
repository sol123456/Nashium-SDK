...
from nashium.core.engine import InteractionResult, MatchConfig, run_match
...
# ============================================================================
# ANSI Colors & Formatting (From Version 1)
# ============================================================================
...
# Renamed functions to match the calls in Version 2 logic (removed leading underscores)
...
# ============================================================================
# DETERMINISM CHECK (From Version 2 - Correct Logic)
# ============================================================================
...
# ============================================================================
# QUALIFY COMMAND (From Version 2 - Correct Logic)
# ============================================================================
...
def cmd_qualify(args: argparse.Namespace) -> int:
    ...
    if qualified:
        ...
        print(
            f"    1. Upload: {Colors.CYAN}nashium upload {submitted_path} --name \"My Bot\" --base-url https://nashium.com{Colors.RESET}")
        print()
        return 0
    else:
...
# ============================================================================
# CHECK COMMAND (From Version 2 - Correct Logic)
# ============================================================================
...
# ============================================================================
# RUN COMMAND (From Version 2 - Correct Logic)
# ============================================================================
...
# ============================================================================
# SEED COMMAND (From Version 1 - Utility)
# ============================================================================
...
# ============================================================================
# UPLOAD COMMAND (From Version 1 - Utility)
# ============================================================================
...
# ============================================================================
# ERROR HANDLING (From Version 1 - Excellent User Feedback)
# ============================================================================
...
Examples:
  ...
  nashium run bot_a.py bot_b.py       Run a match between two bots
    ...
    # Added sandbox flag support for new backend
    p_check.add_argument("--sandbox", action="store_true", help="Run in restricted sandbox (Docker required)")
    ...
    # Added sandbox flag support for new backend
    p_qualify.add_argument("--sandbox", action="store_true", help="Run in restricted sandbox (Docker required)")
